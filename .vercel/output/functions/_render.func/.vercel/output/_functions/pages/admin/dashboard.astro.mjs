/* empty css                                        */
import { c as createAstro, d as createComponent, r as renderComponent, e as renderTemplate, m as maybeRenderHead, f as addAttribute } from '../../chunks/astro/server_DmvSwgss.mjs';
import 'kleur/colors';
import { $ as $$MainLayout } from '../../chunks/MainLayout_BiHwGmTY.mjs';
...
const $$Dashboard = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const ADMIN_PASS = process.env.ADMIN_PASSWORD || "sentry123";
  if (p !== ADMIN_PASS) {
